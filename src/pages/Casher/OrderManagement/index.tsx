  ...
  const handleRefundOk = async () => {
    try {
      ...
      showSuccess(
        ...
        "Lịch hẹn đã được cập nhật trạng thái hoàn tiền."
      );
            ...
            <Space>
              <Select
                ...
                options={[
                  ...
                  {
                    label: "Đã hoàn tiền",
                    value: appointmentStatusEnum.Refunded,
                  }, // ← THÊM (nếu muốn filter)
                ]}
              />
      ...
      >
        <Form form={form} layout="vertical">
          ...
          <Form.Item label="Số tiền đặt cọc hiện tại">
            <Text>
              {(currentAppointment?.depositAmount || 0).toLocaleString(
                "vi-VN",
                {
                  style: "currency",
                  currency: "VND",
